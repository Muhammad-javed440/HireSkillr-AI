      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
          <div className="space-y-5 sm:space-y-8 animate-in slide-in-from-left duration-700">
            <div className="inline-block px-3 py-1 sm:px-4 sm:py-1.5 bg-violet-600/10 border border-violet-500/20 rounded-full text-violet-600 text-xs sm:text-sm font-black uppercase tracking-widest">
              Who We Are
            </div>
            <h1 className="text-3xl 2xs:text-4xl md:text-6xl font-black text-black dark:text-white leading-tight uppercase tracking-tighter">
              WE ARE <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-600">HIRESKILLR AI</span>.<br />
              MAKING SMART TECH.
            </h1>
            <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 leading-relaxed font-medium">
              We started HireSkillr AI to build smart tools that are fast and easy to use.
            ...
            <div className="grid grid-cols-2 gap-6 sm:gap-8 pt-2 sm:pt-4">
              ...
              <div className="space-y-1 sm:space-y-2">
                <div className="text-2xl sm:text-3xl font-black text-violet-600">2.5s</div>
          ...
          <div className="relative animate-in zoom-in duration-700 mt-4 lg:mt-0">
            <div className="absolute -inset-4 bg-gradient-to-r from-indigo-600 to-purple-600 blur-3xl opacity-20 rounded-2xl sm:rounded-[3rem]"></div>
        ...
        <div className="mt-16 sm:mt-24 md:mt-40 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12">
          <div className="space-y-3 sm:space-y-4 group">
            <div className="p-3 sm:p-4 bg-violet-600/10 rounded-xl sm:rounded-2xl w-fit group-hover:bg-violet-600 transition-colors">
              <Target className="w-7 h-7 sm:w-10 sm:h-10 text-violet-600 group-hover:text-white" />
            </div>
          ...
          <div className="space-y-3 sm:space-y-4 group">
            <div className="p-3 sm:p-4 bg-violet-600/10 rounded-xl sm:rounded-2xl w-fit group-hover:bg-violet-600 transition-colors">
              <Rocket className="w-7 h-7 sm:w-10 sm:h-10 text-violet-600 group-hover:text-white" />
            </div>
        ...
        {founder && (
          <div className="mt-16 sm:mt-24 md:mt-40">
            <div className="text-center mb-10 sm:mb-16 space-y-3 sm:space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-violet-600/10 border border-violet-500/20 rounded-full text-violet-600 text-sm font-bold uppercase tracking-wider">
                <Rocket className="w-4 h-4" />
                Founder
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-black dark:text-white uppercase tracking-tighter">
                THE <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">VISIONARY</span> BEHIND
              </h2>
            </div>

            <div className="max-w-3xl mx-auto bg-white dark:bg-black border-2 border-gray-100 dark:border-gray-900 rounded-2xl sm:rounded-[2.5rem] p-6 sm:p-10 md:p-14 relative overflow-hidden group hover:border-violet-500/50 transition-all duration-500 shadow-2xl">
              <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-violet-600/10 to-purple-600/10 blur-[100px] rounded-full"></div>

              <div className="relative flex flex-col md:flex-row items-center gap-8">
                {/* Avatar */}
                <div className="relative flex-shrink-0">
                  <div className="absolute -inset-3 bg-gradient-to-r from-violet-500 to-purple-600 rounded-full blur opacity-30 group-hover:opacity-60 transition-opacity"></div>
                ...
                <div className="flex-grow text-center md:text-left space-y-4">
                  <div>
                    ...
                    <span className="inline-block px-3 py-1 bg-violet-600/10 text-violet-600 text-xs font-bold uppercase tracking-wider rounded-full mt-2">
                  ...
                  <div className="flex items-center gap-3 justify-center md:justify-start pt-2">
                    {founder.email && (
                      <a href={`mailto:${founder.email}`} className="p-2.5 bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400 rounded-xl hover:bg-violet-500 hover:text-white transition-all" title="Email">
        ...
        <div className="mt-16 sm:mt-24 md:mt-40">
          <div className="text-center mb-10 sm:mb-16 space-y-3 sm:space-y-4">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-black dark:text-white uppercase tracking-tighter">
              MEET THE <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">MINDS</span> BEHIND
            </h2>
          ...
          {loadingTeam ? (
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {teamMembers.map((member, index) => (
                <div
                  key={member.id}
                  className="group relative bg-white dark:bg-black border-2 border-gray-100 dark:border-gray-900 rounded-2xl sm:rounded-[2rem] p-5 sm:p-8 hover:border-violet-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-violet-600/10"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  {/* Glow Effect */}
                  <div className="absolute inset-0 bg-gradient-to-br from-violet-600/5 to-purple-600/5 rounded-[2rem] opacity-0 group-hover:opacity-100 transition-opacity"></div>

                  <div className="relative flex flex-col items-center text-center">
                    {/* Profile Image */}
                    <div className="relative mb-6">
                      <div className="absolute -inset-2 bg-gradient-to-r from-violet-500 to-purple-600 rounded-full blur opacity-0 group-hover:opacity-50 transition-opacity"></div>
                    ...
                    <span className="inline-block px-3 py-1 bg-violet-600/10 text-violet-600 text-xs font-bold uppercase tracking-wider rounded-full mb-4">
                      {member.role}
                    </span>
                    ...
                    <div className="flex items-center gap-3">
                      {member.email && (
                        <a
                          ...
                          className="p-2.5 bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400 rounded-xl hover:bg-violet-500 hover:text-white transition-all"
                          title="Send Email"
                        >
                          <Mail className="w-4 h-4" />
                        </a>
